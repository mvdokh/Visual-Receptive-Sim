%% $Id: nnmacros.tex,v 1.1 2005/03/01 06:13:42 judah Exp $
%%
...
\newcommand{\figurenote}[1]{\ifx#1\pscolor{\ ({\em color figure\/})}\fi}
...
%%
\newcommand{\insertfigbody}[1]{\csname #1\endcsname}%
%%
\newcommand{\insertfig}[4][\psmono]{%
  \begin{figure*}\insertfigbody{#2}\titledcaption[#1]{#2}{#3}{#4}\end{figure*}}%
